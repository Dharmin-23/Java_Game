...
import demo.Game_0014;
import demo.Machine_0014;
...
public class GameController {
	...
	void init() {
		...
		// Add as many as you would like, and change numFaults accordingly (but less
		// than 1/3 of total machines)

		machines.add(new Machine_0014());
		machines.add(new Machine_0014());
		machines.add(new Machine_0014());
		machines.add(new Machine_0014());
		machines.add(new Machine_0014());
